⚠️ Since 25 June 2021, there is a new CovApp version 2.0.0, including a new questionnaire and risk assessment developed by the Charité. This repository contains the CovApp version 1.1.0 and is outdated since January 2021.

The latest CovApp Version code is now maintained here: https://github.com/CovOpen/CovApp-2.0
The original CovApp 1.0 code is located here: https://github.com/CovOpen/CovApp-1.0
